...
exports.ChatLevelMedia = void 0;
const n8n_workflow_1 = require("n8n-workflow");
class ChatLevelMedia {
    constructor() {
        this.methods = {
            listSearch: {
                async getDevices() {
        ...
        for (let i = 0; i < items.length; i++) {
            try {
                ...
                if (!deviceId || isNaN(deviceId)) {
                    throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'Invalid Device ID');
                }
                ...
                const responseData = await chatLevelApiRequest.call(this, 'POST', `/devices/${deviceId}/messages/media`, body);
...
exports.ChatLevelMedia = ChatLevelMedia;
